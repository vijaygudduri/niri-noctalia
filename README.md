...
2.  **Install necessaries**
      ...
      ```bash      
      sudo pacman -S --needed --noconfirm nwg-drawer nwg-look gnome-keyring wl-clipboard wl-clip-persist qalculate-gtk gnome-text-editor gnome-clocks blueman nautilus swappy evince brightnessctl playerctl xdg-desktop-portal-gnome xwayland-satellite jq xorg-xrdb just gvfs-mtp gpu-screen-recorder loupe
      ```
