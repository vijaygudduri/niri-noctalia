...
2.  **Install necessaries**
      ...
      ```bash      
      sudo pacman -S --needed --noconfirm nwg-drawer nwg-look polkit-gnome gnome-keyring wl-clipboard starship gnome-calculator gnome-text-editor gnome-clocks blueman nautilus transmission-gtk smplayer swappy evince brightnessctl playerctl wlsunset xdg-desktop-portal-gnome xwayland-satellite python-dbus-next
      ```
